<?php require "../../koneksi.php";
  ...
  if($bulan AND $tahun AND $status){
    $result = mysqli_query($kon, "SELECT * FROM kk INNER JOIN pemohon ON kk.idpemohon = pemohon.idpemohon WHERE MONTH(waktu1) = '$bulan' AND YEAR(waktu1) = '$tahun' AND status = '$status' ORDER BY waktu1 ASC");
  }
...
?>
<h3 style="text-align: center;">Laporan Pembuatan KK</h3>
...
<div id="kanan">
  ...
  <?php QRcode::png($kode,"LaporanKK.png","M",2,2); ?>
  <img src="LaporanKK.png"><br>
