<?php 
require "../../koneksi.php";
  $idpindahkeluar = $_GET['idpindahkeluar'];
  $result = mysqli_query($kon, "SELECT * FROM pindah_keluar INNER JOIN pemohon ON pindah_keluar.idpemohon = pemohon.idpemohon WHERE idpindahkeluar = '$idpindahkeluar'");
...
<h3 style="text-align: center;">SURAT KETERANGAN PINDAH KELUAR</h3>
<h4 style="text-align: center;">Nomor : <?= $inilah['idpindahkeluar'] ?>/103/DISDUKCAPIL/HST</h4>
<br>
...
<div class="container">
  ...
  <table class="table table-sm" style="font-weight: 400;">
    <thead >
      ...
      <tr>
        <td style="font-weight: bold">Alamat Asal</td>
      ...
      <tr>
        <td style="font-weight: bold">Alamat Tujuan</td>
        <td>: <?= $inilah['tujuan'] ?></td>
      </tr>
    </thead>
