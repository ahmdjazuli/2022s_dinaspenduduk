<?php require "../../koneksi.php";
  ...
  if($bulan AND $tahun AND $status){
    $result = mysqli_query($kon, "SELECT * FROM pindah_datang INNER JOIN pemohon ON pindah_datang.idpemohon = pemohon.idpemohon WHERE MONTH(waktu1) = '$bulan' AND YEAR(waktu1) = '$tahun' AND status = '$status' ORDER BY waktu1 ASC");
  }
...
?>
<h3 style="text-align: center;">Laporan Pembuatan SKPD</h3>
...
<tr class="text-center">
  ...
  <td><img src="../../img/<?= $data['file4'] ?>" width='60px'></td>        
</tr>
<?php $i++; ?>
<?php endwhile; ?>
...
<div id="kanan">
  ...
  <?php QRcode::png($kode,"LaporanPindahDatang.png","M",2,2); ?>
  <img src="LaporanPindahDatang.png"><br>
