<?php require "../../koneksi.php";
  ...
  if($bulan AND $tahun AND $status){
    $result = mysqli_query($kon, "SELECT * FROM pindah_keluar INNER JOIN pemohon ON pindah_keluar.idpemohon = pemohon.idpemohon WHERE MONTH(waktu1) = '$bulan' AND YEAR(waktu1) = '$tahun' AND status = '$status' ORDER BY waktu1 ASC");
  }
...
?>
<h3 style="text-align: center;">Laporan Pembuatan SKPK</h3>
...
<div id="kanan">
  ...
  <?php QRcode::png($kode,"LaporanPindahKeluar.png","M",2,2); ?>
  <img src="LaporanPindahKeluar.png"><br>
