<?php require "../../koneksi.php";
  ...
  if($bulan AND $tahun AND $status){
    $result = mysqli_query($kon, "SELECT * FROM pengajuan INNER JOIN pemohon ON pengajuan.idpemohon = pemohon.idpemohon WHERE MONTH(waktu1) = '$bulan' AND YEAR(waktu1) = '$tahun' AND status = '$status' ORDER BY waktu1 ASC");
  }
...
?>
<h3 style="text-align: center;">Laporan Pengajuan KTP</h3>
...
<tr class="text-center">
  ...
  <td><?= $data['nik'] ?></td>        
  <td><img src="../../<?= $data['suratpengantar'] ?>" width='60px'></td>
  <td><img src="../../<?= $data['fotokopikk'] ?>" width='60px'></td>
  <td><img src="../../<?= $data['fotokopiakta'] ?>" width='60px'></td>
    </tr>
<?php $i++; ?>
<?php endwhile; ?>
  </table>
...
<div id="kanan">
  ...
  <?php QRcode::png($kode,"LaporanPengajuanKTP.png","M",2,2); ?>
  <img src="LaporanPengajuanKTP.png"><br>
