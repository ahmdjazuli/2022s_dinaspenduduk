      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-12">
            <div class="card card-widget">
              <div class="card-header">
                <b class="username">Fotokopi Buku Nikah</b>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-minus"></i></button>
                  <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fas fa-times"></i>
                  </button>
...
<?php 
  ...
  if (isset($_POST['upfile1'])) {
        ...
        $query = mysqli_query($kon, "UPDATE pindah_datang SET file1 = '$namabaru' WHERE idpindahdatang = '$idpindahdatang'");
        if($query){
    ...
    if (isset($_POST['upfile2'])) {
        ...
        move_uploaded_file($namafile, '../img/'.$namabaru);
        $query = mysqli_query($kon, "UPDATE pindah_datang SET file2 = '$namabaru' WHERE idpindahdatang = '$idpindahdatang'");
        if($query){
            ?> <script>window.location = 'pindah_datang.php?m=ubah'</script> <?php
        }else{ 
            ?> <script>window.location = 'pindah_datang.php?m=gagal'</script> <?php
    ...
    if (isset($_POST['upfile3'])) {
        ...
        move_uploaded_file($namafile, '../img/'.$namabaru);
        $query = mysqli_query($kon, "UPDATE pindah_datang SET file3 = '$namabaru' WHERE idpindahdatang = '$idpindahdatang'");
        if($query){
            ?> <script>window.location = 'pindah_datang.php?m=ubah'</script> <?php
        }else{ 
            ?> <script>window.location = 'pindah_datang.php?m=gagal'</script> <?php
    ...
    if (isset($_POST['upfile4'])) {
        ...
        move_uploaded_file($namafile, '../img/'.$namabaru);
        $query = mysqli_query($kon, "UPDATE pindah_datang SET file4 = '$namabaru' WHERE idpindahdatang = '$idpindahdatang'");
        if($query){
            ?> <script>window.location = 'pindah_datang.php?m=ubah'</script> <?php
        }else{ 
            ?> <script>window.location = 'pindah_datang.php?m=gagal'</script> <?php
