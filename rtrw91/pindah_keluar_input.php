  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="far fa-calendar-plus"></i> Pembuatan SKPK</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"><i class="far fa-calendar-plus"></i> Pembuatan SKPK</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<?php 
  ...
  if (isset($_POST['simpan'])) {
    ...
    $query = mysqli_query($kon, "INSERT INTO pindah_keluar (waktu1,idpemohon,file1,file2,file3,tujuan,status) VALUES ('$waktu1','$idpemohon','$file1','$file2','$file3','$tujuan','Menunggu')");
      if($query){
        move_uploaded_file($temp1, '../img/'.$file1);
        move_uploaded_file($temp2, '../img/'.$file2);
        move_uploaded_file($temp3, '../img/'.$file3);
      ?> <script>window.location = 'pindah_keluar.php?m=simpan'</script> <?php
      }else{ 
