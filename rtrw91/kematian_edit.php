...
$idskk = $_GET['idskk'];
  $query = mysqli_query($kon, "SELECT * FROM skk INNER JOIN pemohon WHERE idskk = '$idskk'");
...
<?php 
    ...
    $tempat        = $_REQUEST['tempat'];
      $query = mysqli_query($kon, "UPDATE skk SET penyebab = '$penyebab', anakke = '$anakke', tempat = '$tempat' WHERE idskk = '$idskk'");
      if($query){
