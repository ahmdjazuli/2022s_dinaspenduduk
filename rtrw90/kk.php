              ...
              <div class="card-body">
                ...
                <table id="tabelku" class="table table-bordered table-striped table-hover table-sm">
                  ...
                  <tbody>
                    <?php 
                      $no = 1;
                      $query = mysqli_query($kon, "SELECT * FROM kk INNER JOIN pemohon ON kk.idpemohon = pemohon.idpemohon ORDER BY waktu1 DESC");
      ...
      <div class="modal-dialog modal-default">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../assets/report/rKK.php" target="_blank" method="post">
