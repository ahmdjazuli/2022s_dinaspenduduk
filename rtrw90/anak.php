              ...
              <div class="card-body">
                ...
                <table id="tabelku" class="table table-bordered table-striped table-hover table-sm">
                  ...
                  <tbody>
                    <?php 
                      $no = 1;
                      $query = mysqli_query($kon, "SELECT * FROM anak INNER JOIN pemohon ON anak.idpemohon = pemohon.idpemohon ORDER BY waktu1 DESC");
      ...
      <div class="modal-dialog modal-default">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="../assets/report/rAktaAnak.php" target="_blank" method="post">
